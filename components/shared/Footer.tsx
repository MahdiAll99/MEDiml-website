...
export default function FooterSection() {
  return (
    <footer className="relative isolate bg-background text-text">
      {/* subtle grid */}
      {/* <div
        aria-hidden
      ...
      /> */}
      <div
        className="absolute w-1/2 h-1/2 left-20  bottom-0 rounded-[2.5rem] bg-primary/10 blur-3xl transition-opacity duration-500"
        aria-hidden
      />
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-12 md:px-10 md:py-16 md:pb-7">
          ...
          <div className="lg:col-span-2">
            ...
            <form action="#" className="mt-6 flex max-w-xl items-center gap-3">
              ...
              <input
                ...
                className="w-full rounded-xl bg-white/10 px-4 py-3 text-text placeholder:text-text/60 ring-1 ring-white/15 focus:outline-none focus:ring-2 focus:ring-emerald-400"
              />
              <button
                type="submit"
        ...
        {/* divider */}
        <hr className="mt-10 border-white/10 dark:border-black/10" />

        {/* bottom row */}
        <div className="mt-6 flex flex-col items-center justify-center gap-4 text-text/70 md:flex-row ">
